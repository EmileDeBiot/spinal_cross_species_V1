...
human_neurons <- merge(human_neurons, c(human_neurons_KNAF12, human_neurons_KNAF1415, human_neurons_KNAF89))
```
...
```{r}
cross_species <- merge(mouse_neurons, y = c(human_neurons, human_neurons_KNAF12, human_neurons_KNAF1415, human_neurons_KNAF89), by = common_genes)
```
```{r}
mouse_neurons <- NULL
human_neurons <- NULL
...
```{r}
# Drop unwanted layers
cross_species <- subset(x = cross_species, subset = orig.ident %in% c("YADAV", "ZHANG", "KNAF11", "KNAF10", "KNAF9_Humain-P13_NeuN_021024", "KNAF8_Humain-P12_NeuN_021024", "KNAF3", "KNAF4", "KNAF12","MATSON", "KATHE", "GSE7474501", "GSM7474503", "KNAF14", "BOUV5", "KNAF14_Humain-P15_NeuN_a_280325", "KNAF15_Humain-P15_NeuN_b_280325"))
```
