...
```{r}	
cross_species <- subset(x = cross_species, subset = orig.ident %in% c("YADAV", "ZHANG", "KNAF11", "KNAF10", "KNAF9", "KNAF8", "KNAF3", "KNAF4"))
```
...
SaveH5Seurat(cross_species, filename = "data/co_integrated_data/cross_species_human_augmented.h5Seurat", overwrite = TRUE)

```	

```{r}
Convert(source = "data/co_integrated_data/cross_species_human_augmented.h5Seurat", dest = "data/co_integrated_data/cross_species_human_augmented.h5ad", overwrite = TRUE)
```	
