...
# Example usage
# ------------------------------------------------------------------------------
mouse_list <- correct_counts_soupx_seurat(species = "mouse", author = "Skinnider")
...
# ------------------------------------------------------------------------------
saveRDS(mouse_list, file = file.path(mouse_save_path, "skinnider_soupx.rds"))
...
```{r}
# Load the RDS files
mouse_list <- readRDS(file.path(mouse_save_path, "skinnider_soupx.rds"))
...
cell_counts <- sapply(mouse_list,  # mouse_list or human_list 
                      function(seurat_obj) {
                        ncol(seurat_obj)
                        }
                      )
...
# ------------------------------------------------------------------------------
saveRDS(mouse_doublets, file = file.path(mouse_save_path, "mouse_doublets_skinnider.rds"))
...
# ------------------------------------------------------------------------------
saveRDS(merged_mouse, file = file.path(mouse_save_path, "all_samples", "mouse_processed_skinnider.rds"))
...
```{r}
setwd("/shared/projects/cross_species_prof_scn/")
merged_mouse <- readRDS(file.path(mouse_save_path, "all_samples", "mouse_processed_skinninder.rds"))
```
...
# ------------------------------------------------------------------------------
saveRDS(merged_mouse, file = file.path(mouse_save_path, "all_samples", "mouse_integrated_skinnider .rds"))
