...
```{r}
# neurons_mouse_counts <- neurons_mouse_counts[rownames(neurons_mouse_counts) %in% gene_basis, ]
# neurons_human_counts <- neurons_human_counts[rownames(neurons_human_counts) %in% gene_basis, ] 
```
...
```{r}	
cross_species <- subset(x = cross_species, subset = orig.ident %in% c("YADAV", "ZHANG", "KNAF11", "KNAF10", "KNAF9", "KNAF8", "KNAF3", "KNAF4", "KNAF12_Humain-P11_NeuN_180325"))
```
...
SaveH5Seurat(cross_species, filename = "data/co_integrated_data/cross_species_human_augmented+KNAF12.h5Seurat", overwrite = TRUE)

```	

```{r}
Convert(source = "data/co_integrated_data/cross_species_human_augmented+KNAF12.h5Seurat", dest = "data/co_integrated_data/cross_species_human_augmented+KNAF12.h5ad", overwrite = TRUE)
```	
